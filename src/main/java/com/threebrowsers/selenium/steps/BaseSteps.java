...
public abstract class BaseSteps {
    ...
    protected void measureAndLogPageLoad(String stepName, String description, Runnable action, By locator) {
        long loadTime = com.threebrowsers.selenium.utils.PerformanceUtil.measurePageLoad(driver, action, locator);

        com.threebrowsers.selenium.utils.MetricsUtil.addTime(loadTime);
    ...
    protected void assertAndLogPerformanceMetrics() {
        double p95 = com.threebrowsers.selenium.utils.MetricsUtil.getP95();
        long min = com.threebrowsers.selenium.utils.MetricsUtil.getMin();
        long max = com.threebrowsers.selenium.utils.MetricsUtil.getMax();
        double median = com.threebrowsers.selenium.utils.MetricsUtil.getMedian();
        ...
        String metricsSummary = String.format(
                ...
                executionIdentifier.toUpperCase(), min, max, median, p95
        );
